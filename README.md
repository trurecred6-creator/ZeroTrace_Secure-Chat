...
2. Double-click [index.html](file:///Users/masuddarrahaman/Downloads/ZeroTrace/index.html) to open the landing page in your default browser.
...
2. Navigate to the project directory:
   ```bash
   cd /Users/masuddarrahaman/Downloads/ZeroTrace
   ```
...
> 1. Open the [Sender](file:///Users/masuddarrahaman/Downloads/ZeroTrace/sender.html) page in one tab.
> 2. Open the [Receiver](file:///Users/masuddarrahaman/Downloads/ZeroTrace/receiver.html) page in another tab (ensure it's the **same browser**).
